...
import fmt "fmt"
import math "math"
import hlc "github.com/auxten/postgresql-parser/pkg/util/hlc"

import github_com_cockroachdb_cockroach_pkg_util_uuid "github.com/auxten/postgresql-parser/pkg/util/uuid"
...
type TxnMeta struct {
	...
	ID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=id,proto3,customtype=github.com/auxten/postgresql-parser/pkg/util/uuid.UUID" json:"id"`
...
type MVCCWriteIntentOp struct {
	TxnID           github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=txn_id,json=txnId,proto3,customtype=github.com/auxten/postgresql-parser/pkg/util/uuid.UUID" json:"txn_id"`
...
var fileDescriptor_mvcc3_9bc532bf92053320 = []byte{
	...
	,
}
