...
import (
	...
	"github.com/auxten/postgresql-parser/pkg/col/coldata"
	"github.com/auxten/postgresql-parser/pkg/settings/cluster"
	"github.com/auxten/postgresql-parser/pkg/sql/colexec"
	"github.com/auxten/postgresql-parser/pkg/sql/colexec/typeconv"
	"github.com/auxten/postgresql-parser/pkg/sql/execinfra"
	"github.com/auxten/postgresql-parser/pkg/sql/execinfrapb"
	"github.com/auxten/postgresql-parser/pkg/sql/opt/exec/execbuilder"
	"github.com/auxten/postgresql-parser/pkg/sql/opt/optbuilder"
	"github.com/auxten/postgresql-parser/pkg/sql/opt/xform"
	"github.com/auxten/postgresql-parser/pkg/sql/parser"
	"github.com/auxten/postgresql-parser/pkg/sql/rowexec"
	_ "github.com/auxten/postgresql-parser/pkg/sql/sem/builtins"
	"github.com/auxten/postgresql-parser/pkg/sql/sem/tree"
	"github.com/auxten/postgresql-parser/pkg/sql/sqlbase"
	...
	t.Run("vectorized", func(t *testing.T) {
		walk(t, func(t *testing.T, d *datadriven.TestData) string {
			if d.Input == "B'11111111111111111111111110000101'::int4" {
				// Skip this test: https://github.com/auxten/postgresql-parser/pull/40790#issuecomment-532597294.
